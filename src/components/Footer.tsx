  ...
  return (
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center md:text-left">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 justify-items-center md:justify-items-start">
          ...
          <div className="text-center md:text-left">
            ...
            <h4 className="font-semibold mb-4 mt-8">Tools</h4>
            <ul className="space-y-2 text-gray-400">
              <li>
                <Link
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-2 text-gray-400">
              <li><Link href="/terms" className="hover:text-orange-500 transition">Terms of Service</Link></li>
